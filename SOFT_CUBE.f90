...
!!!!!!!! 1. Roof !!!!!!!!!!!!!!
      ...
      uu1(i,j)= wd_a*(ws_b/(ws_a+ws_b))*(roof_temp_b/0.025)*uu11(i,j) + wd_b*(ws_b/(ws_a+ws_b))*(roof_temp_b/0.025)*uu12(i,j) + wd_a*(ws_a/(ws_a+ws_b))*(roof_temp_b/0.025)*uu13(i,j) + wd_b*(ws_a/(ws_a+ws_b))*(roof_temp_b/0.025)*uu14(i,j) + wd_a*(ws_b/(ws_a+ws_b))*(roof_temp_a/0.025)*uu15(i,j) + wd_b*(ws_b/(ws_a+ws_b))*(roof_temp_a/0.025)*uu16(i,j) + wd_a*(ws_a/(ws_a+ws_b))*(roof_temp_a/0.025)*uu17(i,j) + wd_b*(ws_a/(ws_a+ws_b))*(roof_temp_a/0.025)*uu11(i,j)
      vv1(i,j)= wd_a*(ws_b/(ws_a+ws_b))*(roof_temp_b/0.025)*vv11(i,j) + wd_b*(ws_b/(ws_a+ws_b))*(roof_temp_b/0.025)*vv12(i,j) + wd_a*(ws_a/(ws_a+ws_b))*(roof_temp_b/0.025)*vv13(i,j) + wd_b*(ws_a/(ws_a+ws_b))*(roof_temp_b/0.025)*vv14(i,j) + wd_a*(ws_b/(ws_a+ws_b))*(roof_temp_a/0.025)*vv15(i,j) + wd_b*(ws_b/(ws_a+ws_b))*(roof_temp_a/0.025)*vv16(i,j) + wd_a*(ws_a/(ws_a+ws_b))*(roof_temp_a/0.025)*vv17(i,j) + wd_b*(ws_a/(ws_a+ws_b))*(roof_temp_a/0.025)*vv11(i,j)
      ww1(i,j)= wd_a*(ws_b/(ws_a+ws_b))*(roof_temp_b/0.025)*ww11(i,j) + wd_b*(ws_b/(ws_a+ws_b))*(roof_temp_b/0.025)*ww12(i,j) + wd_a*(ws_a/(ws_a+ws_b))*(roof_temp_b/0.025)*ww13(i,j) + wd_b*(ws_a/(ws_a+ws_b))*(roof_temp_b/0.025)*ww14(i,j) + wd_a*(ws_b/(ws_a+ws_b))*(roof_temp_a/0.025)*ww15(i,j) + wd_b*(ws_b/(ws_a+ws_b))*(roof_temp_a/0.025)*ww16(i,j) + wd_a*(ws_a/(ws_a+ws_b))*(roof_temp_a/0.025)*ww17(i,j) + wd_b*(ws_a/(ws_a+ws_b))*(roof_temp_a/0.025)*ww11(i,j)
